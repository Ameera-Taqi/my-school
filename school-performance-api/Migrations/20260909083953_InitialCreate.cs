        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AcademicStageId = table.Column<long>(type: "bigint", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_SchoolClasses_AcademicStages_AcademicStageId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_InternalRequests_Users_RequestedById",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CalendarEventTargetRoles", x => new { x.CalendarEventId, x.RoleKey });
                    table.ForeignKey(
                        name: "FK_CalendarEventTargetRoles_CalendarEvents_CalendarEventId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_InternalRequests_RequestedById",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SchoolClasses_AcademicStageId",
                table: "SchoolClasses",
                column: "AcademicStageId");

            migrationBuilder.CreateIndex(
                name: "IX_Students_CivilId",
                table: "Students",
                column: "CivilId",
                unique: true);
